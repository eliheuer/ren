...
for i in range(6):
    ...
    text("Ren-VF.ttf", (M, (startP)-(i*lineH)))

# Draw small type
fontVariations(wght=400)
tracking(4)
fontSize(24)
text("ABCDEFGHIJKLMNOPQRSTUVWXYZ", (M, (startP)-(i*lineH+(32*3))))
text("abcdefghijklmnopqrstuvwxyz", (M, (startP)-(i*lineH+(32*4))))
